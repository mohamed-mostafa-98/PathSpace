@{
    SchemaVersion = 1
    Actions = @{
        'temp.user' = @{ Title='Remove user temporary files'; Risk='Low'; Reversibility='Irreversible'; RequiresElevation=$false; Handler='DirectoryChildren' }
        ...
        'cache.npm' = @{ Title='Clear npm download cache'; Risk='Low'; Reversibility='Irreversible'; RequiresElevation=$false; Handler='DirectoryChildren' }
